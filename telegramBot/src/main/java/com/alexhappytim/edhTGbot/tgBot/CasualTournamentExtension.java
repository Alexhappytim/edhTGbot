...
public class CasualTournamentExtension implements AbilityExtension {
    ...
    private final BotFacade sessionProvider;

    public CasualTournamentExtension(String restBaseUrl, ObjectMapper objectMapper, RestTemplate restTemplate, SilentSender silent, BotFacade sessionProvider) {
